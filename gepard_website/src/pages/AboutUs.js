...
function AboutUs () {
    return (
    <>
        <div className="flex flex-wrap items-center justify-between my-12 xl:my-12">
            ...
            <div className="w-full xl:w-1/2">
                ...
                <p className="text-4xl xl:text-4xl font-bold text-zinc-700 font-poppins">
                    Dlaczego warto wybrać <span className="text-cocoa_brown">geparda?</span>
                </p>
                <p className="text-lg xl:text-2xl text-zinc-700 font-poppins mt-2 md:mt-4">
