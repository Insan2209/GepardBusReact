            ...
            <div className="grid grid-flow-row grid-cols-1 xl:grid-rows-7 xl:grid-cols-3 gap-5 3xl:gap-16 justify-start my-auto px-8 w-full xl:relative overflow-x-hidden">
                    <div className="xl:col-start-1 xl:col-end-2 xl:row-start-2 xl:row-end-3 w-full h-min">
                        <div className="flex flex-row items-center w-full justify-between">
                            <p className="text-2xl xl:text-4xl font-bold text-zinc-700 dark:text-zinc-300 font-poppins text-left w-full">Bilety miesięczne</p>
                        ...
                        {expandedButtonId === 1 && (
                            ...
                            >
                                <div className="xl:mr-20 mt-6 xl:mt-0">
                                    <p className="text-2xl 2xl:text-4xl font-semibold text-zinc-700 dark:text-zinc-300 font-poppins text-left">Bilety miesięczne na miesiąc <span className="text-cocoa_brown">maj 2024</span></p>
                                    <p className="text-lg 2xl:text-2xl font-semibold text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-8 mb-2">Zakup biletów odbędzie się na dworcu PKP w lokalu 2.06 w dniach:</p>
                                    <ul className="text-md 2xl:text-xl list-disc list-inside text-zinc-700 dark:text-zinc-300">
                                    ...
                                    <p className="text-lg 2xl:text-2xl font-semibold text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-8 mb-2">oraz w Liceum im. Henryka Sienkiewicza w Pajęcznie na portierni w dniach:</p>
                                    <ul className="text-md 2xl:text-xl list-disc list-inside text-zinc-700 dark:text-zinc-300">
                                    ...
                                    <p className="text-md 2xl:text-lg text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-8 mb-2">Informujemy iż sprzedaż biletów miesięcznych na maj 2024 na trasie Więcki-Popów-Kłobuck odbędzie sie tylko w dniach 29.04.2024 - 06.05.2024. Chcąc zakupić bilet miesięczny w innym terminie należy udać się do punktu sprzedaży na Dworcu PKP lok.2.06 w Częstochowie lub na portiernię w Liceum w Pajęcznie.</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <div className="xl:col-start-1 xl:col-end-2 xl:row-start-4 xl:row-end-5 w-full h-min">
                        <div className="flex flex-row items-center w-full justify-between">
                            <p className="text-2xl xl:text-4xl font-bold text-zinc-700 dark:text-zinc-300 font-poppins text-left w-full">Nowości</p>
                            <div className="min-w-fit">
                        ...
                        {expandedButtonId === 2 && (
                            ...
                            >
                                <div className="xl:mr-36 mt-6 xl:mt-0">
                                    <p className="text-2xl 2xl:text-4xl font-semibold text-zinc-700 dark:text-zinc-300 font-poppins text-left">Przejazdy podczas majówki 2024</p>
                                    <p className="text-md 2xl:text-2xl text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-6">Przypominamy, iż <span className="text-cocoa_brown font-semibold">1 i 3 maja</span> nie kursujemy a <span className="text-cocoa_brown font-semibold">2 maja</span> przejazdy odbywać się będą zgodnie z rozkładem niedzielnym.</p>
                                    <p className="text-2xl 2xl:text-4xl font-semibold text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-10">Bilety wieloprzejazdowe</p>
                                    <p className="text-md 2xl:text-2xl text-zinc-700 dark:text-zinc-300 font-poppins text-left mt-6">Przypominamy iż bilet wieloprzejazdowy sprzedawany jest na <span className="text-cocoa_brown font-semibold">minimum 20</span> przejazdów. Możliwość zakupu takiego biletu odbywa się zgodnie z harmonogramem sprzedaży biletów miesięcznych lub w dowolnym momencie u kierowcy.</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    <div className="xl:col-start-1 xl:col-end-2 xl:row-start-6 xl:row-end-7 w-full h-min">
                        <div className="flex flex-row items-center w-full justify-between">
                            <p className="text-2xl xl:text-4xl font-bold text-zinc-700 dark:text-zinc-300 font-poppins text-left w-4/5">Zorganizowane grupy, wycieczki</p>
                            <div className="min-w-fit">
