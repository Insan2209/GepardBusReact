...
function News () {
    ...
    return (
        <div className="flex flex-wrap justify-between w-full my-12 md:my-auto">
            <div className="flex flex-wrap flex-col space-y-12 md:space-y-28 justify-start my-auto px-8 md:py-12 w-full md:relative">
                <div className="flex flex-wrap justify-between w-full md:my-auto">
                    <div className="w-full md:w-1/3 h-min">
                        <div className="flex flex-row items-center w-full justify-between">
                            ...
                            <button className="hidden md:flex" onClick={() => toggleExpansion(1)}>
                                <img
                                    ...
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 1 ? '-scale-x-100' : 'scale-x-100'}`}
                                />
                            </button>
                            ...
                            <button className="flex md:hidden" onClick={() => toggleExpansion(1)}>
                                <img
                                    ...
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 1 ? '-scale-y-100' : 'scale-y-100'}`}
                                />
                            </button>
                        </div>
                        <hr class="h-px w-full my-2 bg-selective_yellow border-0 block"></hr>
                    </div>
                    <div className="flex flex-wrap w-full md:w-2/3 px-0 md:absolute md:right-0 md:top-12">
                        <div
                            className={`md:mr-36 mt-6 md:mt-0 transition-all duration-1000 transform static ${
                                expandedButtonId === 1 ? 'opacity-100 md:translate-x-28' : 'opacity-0 md:translate-x-0'
                            }`}
                        >
                ...
                <div className="flex flex-wrap justify-between w-full md:my-auto">
                    <div className="w-full md:w-1/3 h-min static">
                        <div className="flex flex-row items-center w-full justify-between">
                            ...
                            <button className="hidden md:flex" onClick={() => toggleExpansion(2)}>
                                <img
                                    src="/png/right_arrow.svg"
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 2 ? '-scale-x-100' : 'scale-x-100'}`}
                                />
                            </button>
                            ...
                            <button className="flex md:hidden" onClick={() => toggleExpansion(2)}>
                                <img
                                    src="/png/down_arrow.svg"
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 2 ? '-scale-y-100' : 'scale-y-100'}`}
                                />
                            </button>
                        </div>
                        <hr class="h-px w-full my-2 bg-selective_yellow border-0 block"></hr>
                    ...
                    <div className="flex flex-wrap w-full md:w-2/3 px-0 md:absolute md:right-0 md:top-12">
                        <div
                            className={`md:mr-36 mt-6 md:mt-0 transition-all duration-1000 transform static ${
                                expandedButtonId === 2 ? 'opacity-100 md:translate-x-28' : 'opacity-0 md:translate-x-0'
                            }`}
                        >
                ...
                <div className="flex flex-wrap justify-between w-full md:my-auto">
                        ...
                        <div className="flex flex-row items-center w-full justify-between">
                            ...
                            <button className="hidden md:flex" onClick={() => toggleExpansion(3)}>
                                <img
                                    src="/png/right_arrow.svg"
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 3 ? '-scale-x-100' : 'scale-x-100'}`}
                                />
                            </button>
                            ...
                            <button className="flex md:hidden" onClick={() => toggleExpansion(3)}>
                                <img
                                    src="/png/down_arrow.svg"
                                    alt="arrow"
                                    className={`h-10 w-10 transition-transform duration-1000 transform ${expandedButtonId === 3 ? '-scale-y-100' : 'scale-y-100'}`}
                                />
                            </button>
                        </div>
                        <hr class="h-px w-full my-2 bg-selective_yellow border-0 block"></hr>
                    ...
                    <div className="flex flex-wrap w-full md:w-2/3 px-0 md:absolute md:right-0 md:top-12">
                        <div
                            className={`md:mr-36 mt-6 md:mt-0 transition-all duration-1000 transform static ${
                                expandedButtonId === 3 ? 'opacity-100 md:translate-x-28' : 'opacity-0 md:translate-x-0'
                            }`}
                        >
