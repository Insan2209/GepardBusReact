...
function News () {
    ...
    return (
        <div className="flex flex-wrap justify-between w-full my-12 xl:my-auto min-h-screen">
                        ...
                        {expandedButtonId === 1 && (
                            ...
                            >
                                <div className="xl:mr-36 mt-6 xl:mt-0">
                                    <p className="text-2xl xl:text-4xl font-semibold text-zinc-700 font-poppins text-left">Bilety miesięczne na miesiąc <span className="text-cocoa_brown">maj 2024</span></p>
                                    <p className="text-lg xl:text-2xl font-semibold text-zinc-700 font-poppins text-left mt-8 mb-2">Zakup biletów odbędzie się na dworcu PKP w lokalu 2.06 w dniach:</p>
                                    <ul className="text-md xl:text-xl list-disc list-inside text-zinc-700">
                                    ...
                                    <p className="text-lg xl:text-2xl font-semibold text-zinc-700 font-poppins text-left mt-8 mb-2">oraz w Liceum im. Henryka Sienkiewicza w Pajęcznie na portierni w dniach:</p>
                                    <ul className="text-md xl:text-xl list-disc list-inside text-zinc-700">
                                    ...
                                    <p className="text-md xl:text-lg text-zinc-700 font-poppins text-left mt-8 mb-2">Informujemy iż sprzedaż biletów miesięcznych na maj 2024 na trasie Więcki-Popów-Kłobuck odbędzie sie tylko w dniach 29.04.2024 - 06.05.2024. Chcąc zakupić bilet miesięczny w innym terminie należy przyjechać do punktu sprzedaży na Dworcu PKP lok.2.06 w Częstochowie lub na portiernię w Liceum w Pajęcznie.</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                ...
                <div className="flex flex-wrap justify-between w-full xl:my-auto">
                    ...
                    <AnimatePresence>
                        {expandedButtonId === 2 && (
                            ...
                            >
                                <div className="xl:mr-36 mt-6 xl:mt-0">
                                    <p className="text-2xl xl:text-4xl font-semibold text-zinc-700 font-poppins text-left">Przejazdy podczas majówki 2024</p>
                                    <p className="text-md xl:text-2xl text-zinc-700 font-poppins text-left mt-6">Przypominamy, iż <span className="text-cocoa_brown font-semibold">1 i 3 maja</span> nie kursujemy a <span className="text-cocoa_brown font-semibold">2 maja</span> przejazdy odbywać się będą zgodnie z rozkładem niedzielnym.</p>
                                    <p className="text-2xl xl:text-4xl font-semibold text-zinc-700 font-poppins text-left mt-10">Bilety wieloprzejazdowe</p>
                                    <p className="text-md xl:text-2xl text-zinc-700 font-poppins text-left mt-6">Przypominamy iż bilet wieloprzejazdowy sprzedawany jest na <span className="text-cocoa_brown font-semibold">minimum 20</span> przejazdów. Możliwość zakupu takiego biletu odbywa się zgodnie z harmonogramem sprzedaży biletów miesięcznych lub w dowolnym momencie u kierowcy.</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
