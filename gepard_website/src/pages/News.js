...
function News () {
    ...
    <>
        <div className="flex flex-wrap justify-between w-full my-12 md:my-auto">
            <div className="flex flex-wrap flex-col space-y-6 md:space-y-28 justify-start my-auto px-8 w-full py-10">
                    ...
                    <div className="flex flex-row items-center w-full justify-between">
                        ...
                        <button className="flex md:hidden" onClick={() => toggleExpansion(1)}>
                            <img
                                ...
                                alt="arrow"
                                className={`h-10 transition-transform duration-1000 transform ${expandedButtonId === 1 ? '-scale-y-100' : 'scale-y-100'}`}
                            />
                        </button>
                    </div>
